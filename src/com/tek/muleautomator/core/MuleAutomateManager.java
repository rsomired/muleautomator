	...
	public static void generateMuleFlowFromTibcoProcess(String tibcoProcessPath, String muleConfigPath, Element flowElement) {
		...
		try {
			...
			for(String activityType: activityNodeTypesList){
				...
				switch(pluginType){
				case "jms": JMSHandler.generateMuleFlow(activityType, muleConfigPath, flowElement);
				break;
				case "file": FileHandler.generateMuleFlow(activityType, muleConfigPath, flowElement);
				break;
				}
			}
